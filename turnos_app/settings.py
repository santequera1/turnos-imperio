"""
Django settings for TurneroProyecto project.
...
#SECRET_KEY = 'django-insecure-z^by@h!ju1id*5!0_@o#3%wo3pup=-l1@7@+t7m(!)r9rcllfd'
...
#ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.1.40', '192.168.1.30', '192.168.1.37','192.168.1.28','192.168.1.48','192.168.1.47',
#'192.168.1.45','192.168.1.53','192.168.1.19', '192.168.240.81', '192.168.1.38', '192.168.1.10','192.168.1.43']
...
# TODO: Configurar email de Imperio Motos cuando esté disponible
